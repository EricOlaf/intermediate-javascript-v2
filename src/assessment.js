...
function Sandwich(bread, meat, spread) {
  (this.bread = bread), (this.meat = meat), (this.spread = spread);
}
...
CoinToss.prototype.flip = function() {
  return this.results.push("heads") || this.results.push("tails");
};
...
function partyTime(partyName) {
  var list = [];
  return function addGuest(newGuest) {
    list.push(newGuest);
    return {
      partyName: partyName,
      guestList: list
